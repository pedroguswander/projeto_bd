...
import { useInserirUsuario } from '../hooks/useInserirUsuario'; // Assumindo que o primeiro arquivo está em './useInserirUsuario'
...
function InserirUsuario({ onClose }) {
  // Hooks de mutação
  const mutacaoUsuario = useInserirUsuario();
